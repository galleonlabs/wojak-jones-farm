    ...
    <div className='mx-auto max-w-4xl  min-h-full mb-32 text-gray-900  rounded-sm mt-16  justify-center '>
      <>
        <div className="bg-theme-4 border-2 border-gray-600 justify-center mx-auto pb-10   rounded-sm max-w-4xl py-4  pt-8">
          ...
          {account && harvest && <p className='text-2xl text-center pb-2'>We're currently in our {harvest?.season} harvest {harvest.pause ? <> and within a research and planting period.<br></br>Feel free to browse our historic storage.</> : <> and if you care to stay<br></br> we will be sending the combine harvester out on {harvest?.nextHarvest.toDate().toDateString()}</>}</p>}
